...
function tree(targetDOMelement) { 
	...
	packObject.addCSSClassesToDOMelements = function (selectors, cssClassName, trueFalse) {
		...
		//an example of cssClassName would be: "highlight"
	...
	packObject.loadAndRenderDataset = function (jsonHierarchy) {
	...
	packObject.loadAndRenderFlatDataset = function (flatDataset, rootName, keys) {
	...
	packObject.getDatasetAsJsonD3Hierarchy = function () {
...
//	var hierarchyGraph; //The graph of objects used to represent the hierachy
	...
	function GUPrenderNodes(listOfNodes, clickedNode){
		...
		var mergedSel = enterSelection.merge(selection)
